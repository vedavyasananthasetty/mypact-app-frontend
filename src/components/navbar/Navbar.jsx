...
import {CgLogOut,CgInfinity} from 'react-icons/cg'
...
return (
  <div className={classes.container}>
    <div className={classes.wrapper}>
      ...
      <CgInfinity style={{color:'white', fontSize:'20px'}}/>
        <Link to='/'>
          PaCt
        </Link>
      ...
      <div className={classes.right}>
        <Link to='/upload' style={{ textDecoration: 'none', color: 'inherit' }}>
          <HiOutlineCloudUpload style={{fontSize:'22px'}}/>
        </Link>
...
// import {RiLogoutCircleRFill,RiMapPinUserFill} from 'react-icons/ri'
...
//       <div className={classes.wrapper}>
//         <div className={classes.left}>
//           <CgInfinity className={classes.myicon}/>
//         <Link to='/'>
//           PaCt
//         </Link>
//       </div>
...
//       <div className={classes.right}>
//         <Link to='/upload' style={{textDecoration: 'none', color: 'inherit'}}>
//           <HiOutlineCloudUpload style={{fontSize:'25px'}}/>
//         </Link>
//         <div className={classes.icons}>
//           <RiMapPinUserFill />
//           <RiLogoutCircleRFill onClick={handleLogout} />
//         </div>
